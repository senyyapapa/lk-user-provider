...
type ComplexityRoot struct {
	Query struct {
		UserAuth func(childComplexity int, email string) int
	}
...
type QueryResolver interface {
	UserAuth(ctx context.Context, email string) (*model.UserAuthResult, error)
}
...
func (e *executableSchema) Complexity(ctx context.Context, typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Query.userAuth":
		...
		return e.complexity.Query.UserAuth(childComplexity, args["email"].(string)), true

	case "UserAuthResult.email":
		if e.complexity.UserAuthResult.Email == nil {
			break
		}
...
func (ec *executionContext) field_Query_userAuth_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := ec.field_Query_userAuth_argsEmail(ctx, rawArgs)
	if err != nil {
		return nil, err
	}
	args["email"] = arg0
...
func (ec *executionContext) field_Query_userAuth_argsEmail(
	ctx context.Context,
	rawArgs map[string]any,
) (string, error) {
...
func (ec *executionContext) _Query_userAuth(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (any, error) {
		...
		return ec.resolvers.Query().UserAuth(rctx, fc.Args["email"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	fc.Result = res
	return ec.marshalOUserAuthResult2ᚖmainᚋgraphᚋmodelᚐUserAuthResult(ctx, field.Selections, res)
}
...
func (ec *executionContext) _UserAuthResult_email(ctx context.Context, field graphql.CollectedField, obj *model.UserAuthResult) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_UserAuthResult_email(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
...
func (ec *executionContext) fieldContext_UserAuthResult_email(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
...
func (ec *executionContext) _UserAuthResult_role(ctx context.Context, field graphql.CollectedField, obj *model.UserAuthResult) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_UserAuthResult_role(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
...
func (ec *executionContext) fieldContext_UserAuthResult_role(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "UserAuthResult",
		Field:      field,
		IsMethod:   false,
...
func (ec *executionContext) _UserAuthResult(ctx context.Context, sel ast.SelectionSet, obj *model.UserAuthResult) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "email":
			out.Values[i] = ec._UserAuthResult_email(ctx, field, obj)
...
func (ec *executionContext) marshalOUserAuthResult2ᚖmainᚋgraphᚋmodelᚐUserAuthResult(ctx context.Context, sel ast.SelectionSet, v *model.UserAuthResult) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
